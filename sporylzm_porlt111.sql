...
--
-- Host: localhost:3306
-- Generation Time: Jun 30, 2021 at 01:11 PM
...
(1, 'Davis', 'daviscool567@gmail.com', '1', '9caa367403961a189fd995e8b22a6712dae665d9', ''),
(2, 'Admin', 'admin@admin.com', '1', 'd033e22ae348aeb5660fc2140aec35850c4da997', ''),
(3, 'Romi Pat', 'porlt201@gmail.com', '2', 'a8c42b32a467809f6de20099679a36446a2f8136', '02-Apr-2021'),
(4, 'Giovanny', 'cjpounds1st@gmail.com', '2', '9f976a8155f10839d72a5a0ab7d047add55244be', '22-Apr-2021'),
(5, 'Justice', 'cjpounds@hotmail.com', '1', '9f976a8155f10839d72a5a0ab7d047add55244be', '06-May-2021'),
(6, 'James', 'weverifind@gmail.com', '1', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', '13-May-2021'),
(7, 'Admin Test', 'admin@test.com', '1', '8cb2237d0679ca88db6464eac60da96345513964', '25-Jun-2021');
...
(3, 2, 'V.I Eko Hotel', '12345', '2021-06-29 14:14:25'),
...
--
-- AUTO_INCREMENT for table `inter_cost`
--
ALTER TABLE `inter_cost`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `intra_cost`
--
ALTER TABLE `intra_cost`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `kg_range`
--
ALTER TABLE `kg_range`
...
--
-- AUTO_INCREMENT for table `pickup_area`
--
ALTER TABLE `pickup_area`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `pickup_cities`
--
ALTER TABLE `pickup_cities`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `porlt_users`
--
ALTER TABLE `porlt_users`
...
--
-- Constraints for table `des_area`
--
ALTER TABLE `des_area`
  ADD CONSTRAINT `des_area_ibfk_1` FOREIGN KEY (`state_id`) REFERENCES `des_cities` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `pickup_area`
--
ALTER TABLE `pickup_area`
  ADD CONSTRAINT `pickup_area_ibfk_1` FOREIGN KEY (`state_id`) REFERENCES `pickup_cities` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
