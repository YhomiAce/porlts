...
$sql=$con->query("SELECT * FROM drop_offs WHERE status = 'Pending' AND payment_status = 'Pending' ORDER BY id") or die("Error2 : ". mysqli_error($con));
$count = mysqli_num_rows($sql); 
?>
       <?php echo number_format($count); ?>   UnPaid  Package</p>
      </h2>
...
<table class="table dtable-striped table-hover no-head-border" border="1" style="border:solid; border-color: black; border-width: thin;">
 ...
 <th style="border:solid; border-width: thin; border-color: #eee; color: white; background-color: #0060a0;">Package Type</th> 
 ...
 <th style="border:solid; border-width: thin; border-color: #eee; color: white; background-color: #0060a0;">Date</th>
  ...
  <th style="border:solid; border-width: thin; border-color: #eee; color: white; background-color: #0060a0;">Payment Status</th> 
  ...
  while ($rows=mysqli_fetch_array($sql))
   {
    ...
    $amount=$rows['amount'] != null ? $rows['amount'] : 2500;
...
<tr>
    ...
    <td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $origin_city; ?></td>
    <td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $des_city; ?> </td>
    <td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $sender; ?></td>
    <td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $phone; ?></td>
    <td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $size; ?></td>
    <td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $type; ?></td>
    <td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $weight; ?></td>
    <td style="border:solid; border-width: thin; border-color: #eee;">NGN <?php echo number_format($amount); ?></td>
    <td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $date_t; ?></td>
    <td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $payment_status; ?></td>
    <td style="border:solid; border-width: thin; border-color: #eee;"> <button class="btn btn-primary" onclick="cancel('<?php echo $id; ?>')">Cancel</button></td>
</tr>
...
window.location = "?p=unpaid_package";
}
else if (success = "No")
{
