...
$sql=$con->query("SELECT * FROM porlt_users WHERE kyc_status=1") or die("Error2 : ". mysqli_error($con));
$count = mysqli_num_rows($sql);	
?>
       <?php echo number_format($count); ?> Rejected KYC
      </h2>
...
$sql=$con->query("SELECT * FROM porlt_users WHERE kyc_status=1 ORDER BY id DESC LIMIT 0,500") or die("Error2 : ". mysqli_error($con));
...
<td style="border:solid; border-width: thin; border-color: #eee;"><a href="?p=view_history&u=<?php echo $email; ?>"> <button class="btn btn-primary">Rejected</button></a></td>
</tr>
