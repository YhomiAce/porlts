...
$sql=$con->query("SELECT * FROM des_cities ORDER BY id DESC LIMIT 0,500") or die("Error2 : ". mysqli_error($con));

if(isset($_GET['q']))
{
$q = $_GET['q'];
$sql=$con->query("SELECT * FROM des_cities WHERE cities LIKE '%$q%'  ORDER BY id DESC LIMIT 0, 500") or die("Error2 : ". mysqli_error($con));
}
