...
?>
       <?php echo number_format($count); ?>  Accepted  Drop-Offs</p>
      </h2>
      <p><a href="#"><i class="fa fa-dashboard"></i> Home</a> &nbsp;&nbsp; > &nbsp;&nbsp; <a class="active">Accepted Drop-Offs</a></p>
    </div>
...
<table class="table dtable-striped table-hover no-head-border" border="1" style="border:solid; border-color: black; border-width: thin;">
 ...
 <th style="border:solid; border-width: thin; border-color: #eee; color: white; background-color: #0060a0;">Carier Phone</th> 
...
<th style="border:solid; border-width: thin; border-color: #eee; color: white; background-color: #0060a0;">Unassign</th>
  ...
  while ($rows=mysqli_fetch_array($sql))
   {
    ...
    $weight=$rows['parcel_weight'];
     ...
     $carrier_phone=$rows['carrier_phone'];
...
?>
<tr><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $i; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $origin_city; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $des_city; ?> <td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $sender; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $carrier; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $carrier_phone; ?><td style="border:solid; border-width: thin; border-color: #eee;">NGN <?php echo number_format($earned); ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $travel; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $date_t; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $time_t; ?><td style="border:solid; border-width: thin; border-color: #eee;"><a href="?p=view_customer&id=<?php echo $id; ?>"> <button class="btn btn-primary" onclick="unassign('<?php echo $id; ?>')">Unassign</button></a></td></td></td></td></td></tr>
...
var r = confirm ("Do you want to Unassign this Task?");

if (r == true) {
var dataString='id='+id;  
$.ajax({
type:"GET",
url:"process/unassign_pickup.php",
data:dataString,
jsonp:"callback",
...
if(success == "Yes")
{
alert("Pickup Unassign Successfully!");
window.location = "?p=accepted";
}
else if (success = "No")
{
