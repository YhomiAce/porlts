  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     <div class="row">
      ...
      <p><a href="#"><i class="fa fa-dashboard"></i> Home</a> &nbsp;&nbsp; > &nbsp;&nbsp; <a href="?p=products" class="active">Transactions</a></p>
    </div>
...
$sql=$con->query("SELECT * FROM wallet_trans ORDER BY id DESC LIMIT 0, 200") or die("Error2 : ". mysqli_error($con));

if(isset($_GET['q']))
{
$q = $_GET['q'];
$sql=$con->query("SELECT * FROM wallet_trans WHERE trans_ref LIKE '%$q%' OR user = '$q'  ORDER BY id DESC LIMIT 0, 200") or die("Error2 : ". mysqli_error($con));
}
