...
?>
       <?php echo number_format($count); ?>  Total Delivery Request
      </h2>
...
<th style="border:solid; border-width: thin; border-color: #eee; color: white; background-color: #0060a0;">Amount Paid</th>
...
$sql=$con->query("SELECT * FROM drop_offs WHERE user = '$user' AND payment_status = 'Successful' ORDER BY id DESC LIMIT 0,300") or die("Error2 : ". mysqli_error($con));
...
?>
<tr><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $i; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $user; ?> <td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $origin; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $des; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $weight; ?><td style="border:solid; border-width: thin; border-color: #eee;">NGN <?php echo number_format($amount); ?></td></td></td></td></td></tr>
