...
if(isset($_POST['submit']))
{
  ...
  $exist = searchStates($conn, $state);
  if ($exist) {
    $msg =" State Already Exist";
    $msgClass = "warning";
  }else{
    $save = createNewState($conn, $state);
    if ($save) {
      $msg ="State Added";
      $msgClass = "success";
    }
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     <div class="row">
      ...
      <p><a href="?p=dashbaord"><i class="fa fa-dashboard"></i> Home</a> &nbsp;&nbsp; > &nbsp;&nbsp; <a href="?p=states">States</a></p>
    </div>
...
<tr><td><td style="color: green; font-size: 15px;"></td></tr>
    <tr><td style="width: 30%; font-size: 16px;">New State<td>
      <input  type="text" name="state" required="required" style="width: 100%; height: 40px;">
      </td></td></tr>
