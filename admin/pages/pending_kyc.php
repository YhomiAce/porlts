...
$sql=$con->query("SELECT * FROM porlt_users WHERE pic = '' AND govt_id = ''") or die("Error2 : ". mysqli_error($con));
$count = mysqli_num_rows($sql);	
?>
       <?php echo number_format($count); ?> Awaiting Approval
      </h2>
...
$sql=$con->query("SELECT * FROM porlt_users WHERE pic = '' AND govt_id = '' ORDER BY id DESC LIMIT 0,500") or die("Error2 : ". mysqli_error($con));
...
<td style="border:solid; border-width: thin; border-color: #eee;"><a href="?p=view_history&u=<?php echo $email; ?>"> <button class="btn btn-primary">Awaiting</button></a></td>
</tr>
