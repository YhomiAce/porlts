...
$msgClass="";
    ...
    if(isset($_POST['submit']))
    {
        ...
        if (empty($type)) {
            ...
            $save = updateParcel($conn, $type, $id);
            if ($save) {
                $msg = "Parcel Type Updated Successfully";
                $msgClass = "success";
            }
        }
    }
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     <div class="row">
      ...
      <p><a href="?p=dashbaord"><i class="fa fa-dashboard"></i> Home</a> &nbsp;&nbsp; > &nbsp;&nbsp; <a href="?p=parcel">Parcel</a> &nbsp;&nbsp;  > &nbsp;&nbsp; <a class="active">Edit Parcel Type</a></p>
    </div>
...
<tr><td><td style="color: green; font-size: 15px;"></td></tr>
    <tr><td style="width: 30%; font-size: 16px;">Parcel Type<td>
      <input  type="text" name="type" value="<?= $parcel['type']; ?>" required="required" style="width: 100%; height: 40px;">
      </td></td></tr>
