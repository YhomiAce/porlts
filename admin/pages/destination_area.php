<?php
  ...
  if(isset($_POST['submit'])) {
    ...
    if (empty($state) || empty($area) || empty($post_code)) {
      ...
      $save = saveDestinationArea($conn, $state, $area, $post_code);
      if ($save) {
        $msgClass = "success";
        $msg = "Destination Area saved Successfully";
      }
    }
    ...
    <section class="content-header">
     <div class="row justify-content-center">
      ...
      <h2 style="margin-top: 0px;">
       Add a New Destination Area
      </h2>
      <p><a href="?p=dashboard"><i class="fa fa-dashboard"></i> Home</a> &nbsp;&nbsp; > &nbsp;&nbsp; <a href="?p=des_cities">Destination Area</a> &nbsp;&nbsp;  > &nbsp;&nbsp; <a class="active">Add a New Destination Area</a></p>
    </div>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="card bg-light">
          <div class="card-header">
            <h4>Add Destination Area</h4>

          </div>
          <div class="card-body">
            <div class="form-group">
              <label for="">Select State</label>
              <select name="des_state" id="des_state" class="form-control" >
