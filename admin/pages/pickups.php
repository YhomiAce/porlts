...
?>
       <?php echo number_format($count); ?> Packages Picked Up</p>
      </h2>
      <p><a href="#"><i class="fa fa-dashboard"></i> Home</a> &nbsp;&nbsp; > &nbsp;&nbsp; <a class="active">Pick Ups</a></p>
    </div>
...
<table class="table dtable-striped table-hover no-head-border" border="1" style="border:solid; border-color: black; border-width: thin;">
 ...
 <th style="border:solid; border-width: thin; border-color: #eee; color: white; background-color: #0060a0;">Current Location</th>
...
?>
<tr><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $i; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $origin_city; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $des_city; ?> <td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $sender; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $carrier; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $carrier_id; ?><td style="border:solid; border-width: thin; border-color: #eee;">NGN <?php echo number_format($earned); ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $travel; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $location; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $date_t; ?><td style="border:solid; border-width: thin; border-color: #eee;"><?php echo $time_t; ?><!--<td style="border:solid; border-width: thin; border-color: #eee;"><a href="?p=view_customer&id=<?php echo $id; ?>"> <button class="btn btn-primary">View</button></a></td>--></td></td></td></td></td></td></td></td></td></td></tr>
