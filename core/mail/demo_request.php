...
$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
 $headers .= "From: DIIMTECH  <support@diimtech.com>\r\n";  
//$headers .= "Reply-To: $email_address";	
$headers .= "\r\n";
...
<body style="width:auto">
	<div style="position:absolute; width:100%; margin:50px; background-color:#F4F4F4;">
...
<br><br> Powering real time communication in businesses and workplace.
</div>
