...
$sql="SELECT * FROM drop_offs WHERE origin_city = '$origin' AND des_city = '$des' AND delivery = 'Inter' AND status = 'Pending' AND payment_status = 'Successful'";
...
$drop_offs .= '<a href="#" style="text-decoration:none;" onclick="package_details(\''.$parcel_id.'\')">
