...
$sql="SELECT * FROM drop_offs WHERE user = '$user' AND status = 'Delivered' ORDER BY id DESC";
...
$drop_offs .= '<a href="#" style="text-decoration:none;" onclick="task_details(\''.$parcel_id.'\')">
                    ...
                    <div class="details">
                        <h5 style="font-weight:bold; color:black;"><i class="fa fa-truck" style="color: black; font-size: 18px;"></i>&nbsp;'.$parcel_type.' - '.$parcel_id.'</h5>
